      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-white text-[#003366] p-8 md:p-12 shadow-2xl border-t-4 border-[#C5A059]"
          >
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6">Disclaimer</h2>
            
            <div className="prose prose-sm max-w-none mb-8 opacity-80 leading-relaxed text-justify">
              <p className="mb-4">
            ...
            <div className="flex justify-end">
              <button 
                onClick={handleAgree}
                className="bg-[#003366] text-white px-8 py-3 text-sm uppercase tracking-widest font-bold hover:bg-[#004488] transition-colors duration-300"
              >
                I Agree & Enter
              </button>
            </div>
